...
export type LsxSplit = { production_order_id: string; qty: number }
 ...
 */
export function qtyForLsx(
  lsxId: string,
  input: {
    qty_ordered: number
    main_lsx_id: string | null
    allocations?: LsxSplit[] | null
  },
): number {
...
export function splitProblem(
  qtyOrdered: number,
  allocations: LsxSplit[] | null | undefined,
): string | null {
