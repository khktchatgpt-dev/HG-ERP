...
export const metadata = { title: 'Mua hàng · Vật tư & giá mua' }
 ...
 *     `/planning/materials` vẫn chạy đầy đủ — trang này dẫn sang đó, nói rõ vì sao.
 *
...
export default function Page() {
  return (
    <div className="flex min-h-full flex-col">
      <ScreenHeader eyebrow="Mua hàng" title="Vật tư & giá mua" />
      <div className="flex-1 bg-[var(--surface-card)]">
        <Empty
          headline="Trang này chưa dựng theo sổ thiết kế mới"
          reason="Câu hỏi nó sẽ trả lời: “Mã này là gì, giá bao nhiêu?” Trong lúc chờ, bản cũ vẫn đầy đủ tính năng."
          next={
            <>
              <Btn primary href="/planning/materials">Mở bản cũ</Btn>
