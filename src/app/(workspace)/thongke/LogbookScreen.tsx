...
/** Lệnh đang chạy + cờ trễ hạn (server trang tính sẵn). */
...
export function LogbookScreen({
  ...
  async function removeEntry(en: LogEntry) {
    ...
    setBusy(true)
    try {
      await api(`/api/dept/production/entries/${en.id}`, { method: 'DELETE' })
  ...
  return (
    <div className="flex flex-col gap-4 pb-16">
      ...
      <PageHeader
        ...
        title="Sổ số liệu sản xuất"
        description="Thống kê nhập tập trung theo ngày: lưới kiểu bảng tính (mũi tên/Enter di chuyển, Ctrl+Enter ghi sổ), phế ghi kèm lý do, cuối ngày Chốt sổ để khoá số liệu."
      />
                  ...
                  return (
                    ...
                    >
                      <td className="px-3 py-1.5">
                        <Link
                          href={`/thongke/lsx/${en.production_order_id}`}
